...
/// Create hash key
	long CreateKey( long k1, long k2 )
	{
		long ind = (	(( k1 & ( (1<<HASH_BIT_2) - 1 )) << ( HASH_BIT_2 )) |
					( k2 & ( (1<<HASH_BIT_2) - 1)) ) 
					& ((1<<HASH_LENGTH) - 1);
...
public:
	...
	/// Lookup Method
	int FindKey( long k1, long k2, int& index, long& location )
	{
		/// Create hash key
		long ind = CreateKey ( k1, k2 );
	...
	/// Insertion method
	void InsertKey ( long k1, long k2, int index, int location )
	{
		/// Create hash key
		long ind = CreateKey ( k1, k2 );
...
public:
	...
	/// Lookup Method
	int FindKey( long k1, long k2, float coord[3] )
	{
		/// Create hash key
		long ind = CreateKey ( k1, k2 );
	...
	/// Insertion method
	void InsertKey ( long k1, long k2, float coord[3] )
	{
		/// Create hash key
		long ind = CreateKey ( k1, k2 );
